...
/**
 * This class represents the GetReadyToPut block.
...
public class GetReadyToPut extends Block implements ChangeListener{
	...
	/**
	 * Default level velocity of the robot movement to the approximation point that defines this block.
	 */
	private final Double DEFAULT_VELOCITY = 4.363323129985823;
	/**
	 * Default level acceleration of the robot movement to the approximation point that defines this block.
	 */
	private final Double DEFAULT_ACCELERATION = 8.726646259971647;
	
	/**
	 * Slow level velocity of the robot movement to the approximation point that defines this block.
	 */
	private final Double SLOW_VELOCITY = DEFAULT_VELOCITY/2.0;
	/**
	 * Slow level acceleration of the robot movement to the approximation point that defines this block.
	 */
	private final Double SLOW_ACCELERATION = DEFAULT_ACCELERATION/2.0;
	
	/**
	 * Ultra slow level velocity of the robot movement to the approximation point that defines this block.
	 */
	private final Double ULTRA_SLOW_VELOCITY = DEFAULT_VELOCITY/8.0;
	/**
	 * Ultra slow level acceleration of the robot movement to the approximation point that defines this block.
	 */
	private final Double ULTRA_SLOW_ACCELERATION = DEFAULT_ACCELERATION/8.0;
	
	/**
	 * Velocity of the robot movement to the approximation point that defines this block.
	 */
	protected Double velocity = DEFAULT_VELOCITY;
	/**
	 * Acceleration of the robot movement to the approximation point that defines this block.
	 */
